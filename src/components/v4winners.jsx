  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        if(props.short) {setTransactions(currentDrawResult.result.slice(0,8))}else{
...
{item.g < item.w && <span>&nbsp;<img src="./images/trophy.png"
                ...
                ))}{props.short > 0 && <tr><td><a href="https://poolexplorer.win">See more on the PoolExplorer ---&gt;</a></td></tr>}
              </tbody>
            </table>
          </div>
        </div>
